			...
			<Container>
				...
				>
					<Box
						...
						alignItems='center'
					>	
						<Typography variant='h4' className={provider_styles.providerInitials} width='52px!important' height='52px!important' padding='12px' margin='4px 32px 4px 0' sx={{backgroundColor: 'lightblue'}}>
							PE
						</Typography>
						<Box
							display='flex'
						...
						>
							...
							<Box className={styles.user +' '+ page_styles.textEllipsis}>
								{user_icon()}
							</Box>
						</Box>
					</Box>
